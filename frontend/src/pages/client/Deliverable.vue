    ...
    async submitReview() {
      try {
        ...
        if (data.message && data.message.status === "success") {
          // Only close dialog and refresh after success confirmation
          await this.fetchDeliverables();
        ...
        // Handle any error responses from our API
        ...
        // Handle Frappe specific error formats as fallback
        ...
        // If we reach here without a recognized response format, treat as unknown error
